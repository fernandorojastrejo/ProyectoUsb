    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //          "~/Content/site.css"));
                ...
                // dropZone styles
                bundles.Add(new StyleBundle("~/plugins/dropzone/dropZoneStyles").Include(
            ...
            // lightslider  style
            bundles.Add(new StyleBundle("~/plugins/lightsliderStyle").Include(
                        "~/Content/plugins/lightslider/lightslider.css"));

            // lightslider 
            bundles.Add(new StyleBundle("~/plugins/lightslider").Include(
                        "~/Scripts/plugins/lightslider/lightslider.js"));

            // simplepagination 
            bundles.Add(new StyleBundle("~/plugins/simplePagination").Include(
                        "~/Scripts/plugins/simplePagination/jquery.simplePagination.js"));

            // Control de mensajes
            bundles.Add(new StyleBundle("~/Scripts/controlmensajes").Include(
                        "~/Scripts/controlmensaje.js"));
        }
    }
}
